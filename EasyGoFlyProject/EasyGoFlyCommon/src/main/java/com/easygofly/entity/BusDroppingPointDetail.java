...
@Entity
@Table(name = "bus_dropping_point_details")
public class BusDroppingPointDetail {
	@Id
	...
	public BusDroppingPointDetail() {}

	public BusDroppingPointDetail(Integer cityPointIndex, String cityPointLocation, String cityPointName,
