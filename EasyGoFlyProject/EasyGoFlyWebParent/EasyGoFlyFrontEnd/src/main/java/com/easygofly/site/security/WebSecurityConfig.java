	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
			.antMatchers("/", "/favicon/**", "/site-logo/**", "/customers/**", "/login**", "/registration/**", "/hotel", "/about/**", 
					...
					"/flight_international_search_save", "/flight_search-noUser**", "/brand-logos/**", "/jaipur_view", "/site-logo/**", "/get_value", "/rishikesh_view", 
					...
					"/flight_search-noUser_filter_**", "/save_meal", "/test").permitAll()
