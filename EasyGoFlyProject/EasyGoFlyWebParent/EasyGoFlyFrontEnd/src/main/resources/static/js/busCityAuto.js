function autocomplete(inp, arr, ids) {
  ...
  inp.addEventListener("input", function(e) {
      ...
      a.setAttribute("style", "position: absolute; background: white; width: 100%; z-index: 2;");
...
autocomplete(myInput, cityNames, cityIds);
autocomplete(myInputDestin, cityNames, cityIds);