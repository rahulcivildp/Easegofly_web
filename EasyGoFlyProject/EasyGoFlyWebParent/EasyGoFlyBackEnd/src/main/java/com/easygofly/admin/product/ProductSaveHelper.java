...
public class ProductSaveHelper {
	...
	public static void setProductDetails(Product products, String pnr, String totalSeats, String uploadSeats, String flightNum, Date date,
		...
		if(pnr == null || flightNum == null) return;
			...
			products.addDetail(pnr1, totalSeats1, uploadSeats1, flightNum1, date1, depTime1, arrTime1, priceADT1, priceINF1, markupADT1, markupINF1, cityOne1, cityTwo1, inStock1, enabled1, stopNum);
